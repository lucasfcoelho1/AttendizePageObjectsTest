...
public class CreateSurveyTest {
    ...
    @Test
    public void testCT08CreateASurvey() throws InterruptedException {
        ...
        SurveysPage surveysPage = ticketsPage
                .getMenu()
                .goToSurveyPage();

        assertEquals("No Questions Yet", surveysPage.getCentralText());
        surveysPage
                .clickCreateQuestion()
                .fillQuestionTitle("Gostou do evento?")
                .changeComboboxTo("Radio input")
                .fillFirstQuestion("Bom")
                .clickAddAnotherOption()
                .fillSecondQuestion("Ruim")
                .clickRequiredQuestionCheckbox()
                .clickSaveQuestion();
        
        Thread.sleep(2000);
        assertTrue("Survey Question Is Not Visible",
                surveysPage.isSurveyQuestionVisible());
    }
}
